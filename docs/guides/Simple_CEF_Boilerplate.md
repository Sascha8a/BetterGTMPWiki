...
- Browser/cef => Client:
  - [ResourceCall](api/Client.md?id=ResourceCall)
  - [ResourceEval](api/Client.md?id=ResourceEval)
- Client => Browser:
  - [browser.call](api/Client.md?id=browsercall)
  - [browser.eval](api/Client.md?id=browsereval)
